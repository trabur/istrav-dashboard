...
export let channelGuidesTemplate = /*html*/`
  <h2>::: channel.guides()</h2>
  ...
  <div id="getVideosCode"></div>
  <div class="script-actions">
    <a class="waves-effect waves-light btn" onclick="window.doRun('getVideos'); return false;">run</a>
  </div>
...
import {
  ...
  getRemove,
  getVideos
} from '../scripts/channel.guides.js'

export function channelGuidesInit () {
