...
export let channelPlaylistsTemplate = /*html*/`
  ...
  <div id="getGuidesCode"></div>
  <div class="script-actions">
    <a class="waves-effect waves-light btn" onclick="window.doRun('getGuides'); return false;">run</a>
  </div>
...
import {
  ...
  getRemove,
  getGuides
} from '../scripts/channel.playlists.js'

export function channelPlaylistsInit () {
