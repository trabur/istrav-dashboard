...
export let accountUsersTemplate = /*html*/`
  ...
  <div class="script-actions">
    <a class="waves-effect waves-light btn" onclick="window.doRun(sourceId, 'getNew', logTo, backupTo); return false;">run</a>
  </div>

  <p>hello fleet</p>
  <div id="getAllCode"></div>
  <div class="script-actions">
    <a class="waves-effect waves-light btn" onclick="window.doRun(sourceId, 'getAll', logTo, backupTo); return false;">run</a>
  </div>
